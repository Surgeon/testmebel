...
# RailsAdmin config file. Generated on October 24, 2011 16:32
...
RailsAdmin.config do |config|
  ...
  # config.excluded_models << [Category, City, Company, Region, Xlink]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models << [Category, City, Company, Region, Xlink]
...
# Fields may also be marked as read_only (and thus not editable) if they are not mass-assignable by current_user
  ...
  #   # Found associations:
  #   field :companies, :has_and_belongs_to_many_association
  #   # Found columns:
  #   field :id, :integer
  #   field :name, :string
...
# Fields may also be marked as read_only (and thus not editable) if they are not mass-assignable by current_user
  ...
  #   # Found associations:
  #   field :companies, :has_many_association
  #   field :region, :belongs_to_association
  #   # Found columns:
  #   field :id, :integer
  #   field :name, :string
  #   field :region_id, :integer        # Hidden
  #   field :created_at, :datetime
  #   field :updated_at, :datetime
  #   field :million, :boolean
  #   field :xlink, :integer
  #   field :rod_case, :string
  #   field :pred_case, :string
  #   # Sections:
  #   list do; end
  #   export do; end
  #   show do; end
